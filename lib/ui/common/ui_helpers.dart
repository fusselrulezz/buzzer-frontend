...
/// The `small` size constant used for spacing in the UI.
const double smallSize = 10.0;

/// The `medium` size constant used for spacing in the UI.
const double mediumSize = 25.0;

/// The `large` size constant used for spacing in the UI.
const double largeSize = 50.0;

/// The `massive` size constant used for spacing in the UI.
const double massiveSize = 120.0;

/// Utility widget for a horizontal space of the [tinySize].
const Widget horizontalSpaceTiny = SizedBox(width: tinySize);

/// Utility widget for a horizontal space of the [smallSize].
const Widget horizontalSpaceSmall = SizedBox(width: smallSize);

/// Utility widget for a horizontal space of the [mediumSize].
const Widget horizontalSpaceMedium = SizedBox(width: mediumSize);

/// Utility widget for a horizontal space of the [largeSize].
const Widget horizontalSpaceLarge = SizedBox(width: largeSize);

/// Utility widget for a vertical space of the [massiveSize].
